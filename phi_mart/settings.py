...
SECRET_KEY = 'django-insecure-ku))p=(d!^t9xs!tq^amr=f8g*2_f_5jd7&gg4t*oe&w62=_#&'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://localhost:5174",
    "https://phi-mart-client-lemon.vercel.app"
]
INTERNAL_IPS = [
    # ...
    "127.0.0.1",
...
DJOSER={
    'EMAIL_FRONTEND_PROTOCOL' : config('FRONTEND_PROTCOOL'),
