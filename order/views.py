...
def initialize_payment(request):
    ...
    settings = { 'store_id': 'phima68f8eab3936bc', 'store_pass': 'phima68f8eab3936bc@ssl', 'issandbox': True }
...
def payment_success(request):
    ...
    order.save()
    return HttpResponseRedirect(f"{main_settings.FRONTEND_URL}/dashboard/payment/orders/")
